...
export function ClothingClient({ initialProducts, totalCount, initialLimit, categorySlug, filterOptions, currentFilters }: ClothingClientProps) {
  ...
  useEffect(() => {
    const restoreState = async () => {
      const savedScrollPosition = sessionStorage.getItem("clothingPageScrollPosition")
      const savedProductCount = sessionStorage.getItem("clothingPageLoadedCount")
      ...
      if (savedProductCount && savedScrollPosition) {
        ...
        sessionStorage.removeItem("clothingPageScrollPosition")
        sessionStorage.removeItem("clothingPageLoadedCount")
      }
  ...
  useEffect(() => {
    const handleBeforeUnload = () => {
      sessionStorage.setItem("clothingPageScrollPosition", window.scrollY.toString())
      sessionStorage.setItem("clothingPageLoadedCount", products.length.toString())
    }
  ...
  const buildFilterUrl = () => {
    ...
    return `/clothing${params.toString() ? `?${params.toString()}` : ""}`
  }
    ...
    <div className="py-8">
      <div className="max-w-[1920px] mx-auto">
        ...
        <div className="mb-7 px-4">
          <h1 className="text-[15px] font-normal tracking-[0.15em] mb-6 text-[#111111] uppercase">CLOTHING</h1>
        </div>

        <CategoryNavigationTabs currentCategory="clothing" />
        ...
        {sortedProducts.length === 0 ? (
          <div className="text-center py-16 px-8">
            <p className="text-gray-400 text-sm tracking-widest uppercase">NO CLOTHING FOUND</p>
          </div>
        ) : (
          <>
