...
const OUTERWEAR_CATEGORIES = [
  {
    id: "puffer-jacket",
    label: "Puffer Jacket",
    image: "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Category%20Slider/Women/Outerwear/Dior%20Puffer%20Jacket%20Women.jpg",
    route: "/womens/outerwear/puffer-jackets",
  },
  {
    id: "down-jacket",
    label: "Down Jacket",
    image: "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Category%20Slider/Women/Outerwear/Prada%20Down%20Jacket%20Women.jpg",
    route: null, // TODO: connect to /womens/outerwear/down-jackets when ready
  },
  {
    id: "bomber-jacket",
    label: "Bomber Jacket",
    image: "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Category%20Slider/Women/Outerwear/MiuMiu%20Bomber%20Jacket%20Women.jpg",
    route: "/womens/outerwear/bomber-jackets",
  },
  {
    id: "leather-jacket",
    label: "Leather Jacket",
    image: "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Category%20Slider/Women/Outerwear/Dior%20Leather%20Jacket%20Women.jpg",
    route: "/womens/outerwear/leather-jackets",
  },
  {
    id: "trench-coat",
    label: "Trench Coat",
    image: "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Category%20Slider/Women/Outerwear/Dior%20Trech%20Coat%20Women.jpg",
    route: "/womens/outerwear/trench-coats",
  },
  {
    id: "wool-coat",
    label: "Wool Coat",
    image: "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Category%20Slider/Women/Outerwear/Dior%20Wool%20Coat%20Women.jpg",
    route: "/womens/outerwear/wool-coats",
  },
  {
    id: "parka",
    label: "Parka",
    image: "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Category%20Slider/Women/Outerwear/Canada%20Goose%20Parka%20Women.jpg",
    route: "/womens/outerwear/parkas",
  },
] as const

interface WomensOuterwearCategoryCarouselProps {
  activeCategoryLabel?: string | null
}

export function WomensOuterwearCategoryCarousel({ activeCategoryLabel = null }: WomensOuterwearCategoryCarouselProps) {
