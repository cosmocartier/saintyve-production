...
interface WomensBagsClientProps {
...
export function WomensBagsClient({
  initialProducts,
  totalCount,
  initialLimit,
  categoryId,
  ...
  useEffect(() => {
    const restoreState = async () => {
      const savedScrollPosition = sessionStorage.getItem("womensBagsPageScrollPosition")
      const savedProductCount = sessionStorage.getItem("womensBagsPageLoadedCount")
      ...
      if (savedProductCount && savedScrollPosition) {
        ...
        sessionStorage.removeItem("womensBagsPageScrollPosition")
        sessionStorage.removeItem("womensBagsPageLoadedCount")
      }
  ...
  useEffect(() => {
    const handleBeforeUnload = () => {
      sessionStorage.setItem("womensBagsPageScrollPosition", window.scrollY.toString())
      sessionStorage.setItem("womensBagsPageLoadedCount", products.length.toString())
    }
  ...
  const buildFilterUrl = () => {
    ...
    return `/womens/bags${params.toString() ? `?${params.toString()}` : ""}`
  }
      ...
      <div className="max-w-[1920px] mx-auto">
        <div className="mb-6 px-4">
          ...
          <p className="text-[13px] text-[#111111] leading-relaxed mb-6">
            Discover our sophisticated collection of women&apos;s bags, from timeless handbags and versatile totes to
            elegant clutches and practical crossbody styles. Each piece is designed to elevate your everyday look with
            quality craftsmanship and modern elegance.
          </p>
        </div>
