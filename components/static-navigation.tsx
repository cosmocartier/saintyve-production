...
const newCategories = [
  ...
  {
    name: "TRENDING",
    subcategories: ["Viral", "Best Sellers", "Editor's Picks", "Seen on Social"],
  },
  {
    name: "SEASONAL",
    subcategories: ["Autumn Winter", "Spring Summer", "Holiday Collection"],
  },
]
...
const menCategories = [
  ...
  {
    name: "TOPS",
    subcategories: ["T-Shirts", "Shirts", "Hoodies", "Sweaters", "Tank Tops"],
  },
  {
    name: "BOTTOMS",
    subcategories: ["Jeans", "Trousers", "Shorts", "Joggers", "Sweatpants"],
  },
  {
    name: "OUTERWEAR",
    subcategories: ["Jackets", "Coats", "Blazers", "Vests", "Parkas"],
  },
  {
    name: "SHOES",
    subcategories: ["Sneakers", "Boots", "Sandals", "Loafers", "Formal"],
  },
  {
    name: "ACCESSORIES",
    subcategories: ["Bags", "Hats", "Belts", "Wallets", "Sunglasses", "Jewelry"],
  },
  {
    name: "SALE",
    subcategories: ["Up to 30%", "Up to 50%", "Up to 70%", "Clearance"],
  },
]
...
const womenCategories = [
  ...
  {
    name: "TOPS",
    subcategories: ["T-Shirts", "Blouses", "Hoodies", "Sweaters", "Crop Tops"],
  },
  {
    name: "BOTTOMS",
  ...
  {
    name: "DRESSES",
    subcategories: ["Casual", "Formal", "Midi", "Mini", "Maxi"],
  },
  {
    name: "OUTERWEAR",
    subcategories: ["Jackets", "Coats", "Blazers", "Cardigans", "Parkas"],
  },
  {
    name: "SHOES",
  ...
  {
    name: "ACCESSORIES",
    subcategories: ["Bags", "Hats", "Belts", "Jewelry", "Scarves"],
  },
  {
    name: "SALE",
    subcategories: ["Up to 30%", "Up to 50%", "Up to 70%", "Clearance"],
...
export function StaticNavigation() {
  ...
  const getCategoriesForMenu = (menu: string) => {
    switch (menu) {
      case "NEW":
    ...
    try {
      ...
      const productsWithImages =
        data?.map((product) => ({
          ...product,
          image_url:
            product.product_images?.sort((a: any, b: any) => a.display_order - b.display_order)[0]?.url ||
            "/placeholder.svg",
        })) || []
