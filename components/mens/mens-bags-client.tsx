...
export function MensBagsClient({
  initialProducts,
  totalCount,
  initialLimit,
  categoryId,
  activeCategoryLabel = null,
  pageTitle = "MEN'S BAGS",
  ...
  useEffect(() => {
    const restoreState = async () => {
      const savedScrollPosition = sessionStorage.getItem("mensBagsPageScrollPosition")
      const savedProductCount = sessionStorage.getItem("mensBagsPageLoadedCount")
      ...
      if (savedProductCount && savedScrollPosition) {
        ...
        sessionStorage.removeItem("mensBagsPageScrollPosition")
        sessionStorage.removeItem("mensBagsPageLoadedCount")
      }
  ...
  useEffect(() => {
    const handleBeforeUnload = () => {
      sessionStorage.setItem("mensBagsPageScrollPosition", window.scrollY.toString())
      sessionStorage.setItem("mensBagsPageLoadedCount", products.length.toString())
    }
  ...
  const buildFilterUrl = () => {
    ...
    return `/mens/bags${params.toString() ? `?${params.toString()}` : ""}`
  }
      ...
      <div className="max-w-[1920px] mx-auto">
        <div className="mb-6 px-4">
          ...
          <p className="text-[13px] text-[#111111] leading-relaxed mb-6">
            Explore our curated collection of men&apos;s bags, featuring everything from sleek backpacks and briefcases
            to versatile totes and crossbody bags. Each piece is carefully selected to blend timeless style with
