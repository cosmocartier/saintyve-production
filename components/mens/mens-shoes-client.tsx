...
interface MensShoesClientProps {
...
export function MensShoesClient({
  initialProducts,
  totalCount,
  initialLimit,
  categoryId,
  ...
  useEffect(() => {
    const restoreState = async () => {
      const savedScrollPosition = sessionStorage.getItem("mensShoesPageScrollPosition")
      const savedProductCount = sessionStorage.getItem("mensShoesPageLoadedCount")
      ...
      if (savedProductCount && savedScrollPosition) {
        ...
        sessionStorage.removeItem("mensShoesPageScrollPosition")
        sessionStorage.removeItem("mensShoesPageLoadedCount")
      }
  ...
  useEffect(() => {
    const handleBeforeUnload = () => {
      sessionStorage.setItem("mensShoesPageScrollPosition", window.scrollY.toString())
      sessionStorage.setItem("mensShoesPageLoadedCount", products.length.toString())
    }
  ...
  const buildFilterUrl = () => {
    ...
    return `/mens/shoes${params.toString() ? `?${params.toString()}` : ""}`
  }
      ...
      <div className="max-w-[1920px] mx-auto">
        <div className="mb-6 px-4">
          ...
          <p className="text-[13px] text-[#111111] leading-relaxed mb-6">
            Explore our curated collection of men&apos;s shoes, featuring everything from sleek sneakers and classic
            loafers to refined dress shoes and casual kicks. Each pair is carefully selected to blend timeless style with
            modern comfort.
          </p>
        </div>
