...
const WATCH_CATEGORIES = [
  ...
  { id: "gold-twotone", label: "Gold / Two-Tone" },
  { id: "leather-strap", label: "Leather Strap" },
  { id: "stainless-steel", label: "Stainless Steel" },
] as const

export function MensWatchesCategorySlider() {
  const [selectedCategory, setSelectedCategory] = useState<string>(WATCH_CATEGORIES[0].id)
