...
const OUTERWEAR_CATEGORIES = [
  { id: "puffer-jacket", label: "Puffer Jacket" },
  { id: "down-jacket", label: "Down Jacket" },
...
export function MensOuterwearCategorySlider() {
  const [selectedCategory, setSelectedCategory] = useState<string>(OUTERWEAR_CATEGORIES[0].id)
