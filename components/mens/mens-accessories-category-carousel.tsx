...
const ACCESSORIES_CATEGORIES = [
  {
    ...
    label: "Belts",
    image:
      "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Untitled%20folder/Screenshot%202025-12-29%20at%2015.08.01.jpg",
    route: "/mens/accessories/belts",
  },
  {
    id: "sunglasses",
    label: "Sunglasses",
    image:
      "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Untitled%20folder/Screenshot%202025-11-26%20at%2022.55.21.jpg",
    route: "/mens/accessories/sunglasses",
  },
  {
    id: "hats-caps",
    label: "Hats & Caps",
    image:
      "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Untitled%20folder/Screenshot%202025-12-30%20at%2018.21.45.jpg",
    route: "/mens/accessories/hats-caps",
  },
  {
    id: "scarves",
    label: "Scarves",
    image:
      "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Untitled%20folder/GUCCI%20SCARF.jpg",
    route: "/mens/accessories/scarves",
  },
  {
    id: "cardholders",
    label: "Cardholders",
    image:
      "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Untitled%20folder/Goyard%20Cardholder.jpg",
    route: "/mens/accessories/cardholders",
  },
  {
    id: "jewelry",
    label: "Jewelry",
    image:
      "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Untitled%20folder/Gucci%20Bracelet.jpg",
    route: "/mens/accessories/jewelry",
  },
  {
    id: "tech",
    label: "Tech Accessories",
    image:
      "https://pakchkjehxmkcqoxqwir.supabase.co/storage/v1/object/public/product-images/Untitled%20folder/Rimowa%20Case.jpg",
    route: "/mens/accessories/tech-accessories",
  },
] as const

interface MensAccessoriesCategoryCarouselProps {
  activeCategoryLabel?: string | null
}

export function MensAccessoriesCategoryCarousel({ activeCategoryLabel = null }: MensAccessoriesCategoryCarouselProps) {
