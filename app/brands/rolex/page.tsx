...
import { RolexClient } from "@/components/brands/rolex-client"
...
export default async function RolexPage({
  ...
  // Get available categories for Rolex products
  ...
  if (productsError) {
    console.error("Error fetching Rolex products:", productsError)
  }
