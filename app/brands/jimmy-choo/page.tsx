...
import { JimmyChooClient } from "@/components/brands/jimmy-choo-client"
...
export default async function JimmyChooPage({
  searchParams,
}: {
  ...
  // Get available categories for Jimmy Choo products
  ...
  if (productsError) {
    console.error("Error fetching Jimmy Choo products:", productsError)
  }
