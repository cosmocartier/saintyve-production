...
import { AdidasClient } from "@/components/brands/adidas-client"
...
export default async function AdidasPage({
  ...
  // Get available categories for Adidas products
  ...
  if (productsError) {
    console.error("Error fetching Adidas products:", productsError)
  }
