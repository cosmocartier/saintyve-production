...
import { LouboutinClient } from "@/components/brands/louboutin-client"
...
export default async function LouboutinPage({
  searchParams,
}: {
  ...
  // Get available categories for Louboutin products
  ...
  if (productsError) {
    console.error("Error fetching Louboutin products:", productsError)
  }
