...
import { NikeClient } from "@/components/brands/nike-client"
...
export const metadata: Metadata = {
  title: "Nike | Designerdrip",
  description:
    "Discover the iconic Nike collection. From legendary sneakers to performance apparel, explore the brand that revolutionized athletic footwear and sportswear worldwide.",
}
...
export default async function NikePage({
  ...
  // Get available categories for Nike products
  ...
  if (productsError) {
    console.error("Error fetching Nike products:", productsError)
  }
