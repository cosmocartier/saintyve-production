...
import { DiorClient } from "@/components/brands/dior-client"
...
export default async function DiorPage({
  ...
  // Get available categories for Dior products
  ...
  if (productsError) {
    console.error("Error fetching Dior products:", productsError)
  }
