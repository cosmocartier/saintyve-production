...
import { AlexanderMcQueenClient } from "@/components/brands/alexander-mcqueen-client"
...
export default async function AlexanderMcQueenPage({
  searchParams,
}: {
  ...
  // Get available categories for Alexander McQueen products
  ...
  if (productsError) {
    console.error("Error fetching Alexander McQueen products:", productsError)
  }
