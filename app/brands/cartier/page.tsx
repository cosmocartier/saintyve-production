...
import { CartierClient } from "@/components/brands/cartier-client"
...
export default async function CartierPage({
  searchParams,
}: {
  ...
  // Get available categories for Cartier products
  ...
  if (productsError) {
    console.error("Error fetching Cartier products:", productsError)
  }
