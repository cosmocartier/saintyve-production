...
import { FerragamoClient } from "@/components/brands/ferragamo-client"
...
export default async function FerragamoPage({
  searchParams,
}: {
  ...
  // Get available categories for Ferragamo products
  ...
  if (productsError) {
    console.error("Error fetching Ferragamo products:", productsError)
  }
