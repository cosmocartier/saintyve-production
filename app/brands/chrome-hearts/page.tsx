...
import { ChromeHeartsClient } from "@/components/brands/chrome-hearts-client"
...
export default async function ChromeHeartsPage({
  searchParams,
}: {
  ...
  // Get available categories for Chrome Hearts products
  ...
  if (productsError) {
    console.error("Error fetching Chrome Hearts products:", productsError)
  }
