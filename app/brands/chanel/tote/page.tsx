...
export default async function ChanelTotePage() {
  const products = await getChanelProducts()
  const filtered = products.filter((product: any) => /\btote\b/i.test(product.model || ""))
  ...
  return (
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <ChanelCategoryClient initialProducts={filtered} title="Tote" />
      </div>
