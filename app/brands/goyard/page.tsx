...
import { GoyardClient } from "@/components/brands/goyard-client"
...
export default async function GoyardPage({
  searchParams,
}: {
  ...
  // Get available categories for Goyard products
  ...
  if (productsError) {
    console.error("Error fetching Goyard products:", productsError)
  }
