...
import { CanadaGooseClient } from "@/components/brands/canada-goose-client"
...
export default async function CanadaGoosePage({
  searchParams,
}: {
  ...
  // Get available categories for Canada Goose products
  ...
  if (productsError) {
    console.error("Error fetching Canada Goose products:", productsError)
  }
