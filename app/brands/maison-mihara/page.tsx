...
import { MaisonMiharaClient } from "@/components/brands/maison-mihara-client"
...
export default async function MaisonMiharaPage({
  searchParams,
}: {
  ...
  // Get available categories for Maison Mihara products
  ...
  if (productsError) {
    console.error("Error fetching Maison Mihara products:", productsError)
  }
