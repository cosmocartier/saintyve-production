...
import { RimowaClient } from "@/components/brands/rimowa-client"
...
export default async function RimowaPage({
  searchParams,
}: {
  ...
  // Get available categories for Rimowa products
  ...
  if (productsError) {
    console.error("Error fetching Rimowa products:", productsError)
  }
