...
import { GivenchyClient } from "@/components/brands/givenchy-client"
...
export default async function GivenchyPage({
  searchParams,
}: {
  ...
  // Get available categories for Givenchy products
  ...
  if (productsError) {
    console.error("Error fetching Givenchy products:", productsError)
  }
