...
import { CesarePaciottiClient } from "@/components/brands/cesare-paciotti-client"
...
export default async function CesarePaciottiPage({
  searchParams,
}: {
  ...
  // Get available categories for Cesare Paciotti products
  ...
  if (productsError) {
    console.error("Error fetching Cesare Paciotti products:", productsError)
  }
