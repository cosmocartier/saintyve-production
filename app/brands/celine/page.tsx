...
import { CelineClient } from "@/components/brands/celine-client"
...
export default async function CelinePage({
  searchParams,
}: {
  ...
  // Get available categories for Celine products
  ...
  if (productsError) {
    console.error("Error fetching Celine products:", productsError)
  }
