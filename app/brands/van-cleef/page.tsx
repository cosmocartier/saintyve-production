...
import { VanCleefClient } from "@/components/brands/van-cleef-client"
...
export default async function VanCleefPage({
  searchParams,
}: {
  ...
  // Get available categories for Van Cleef products
  ...
  if (productsError) {
    console.error("Error fetching Van Cleef products:", productsError)
  }
