...
import { MonclerClient } from "@/components/brands/moncler-client"
...
export default async function MonclerPage({
  searchParams,
}: {
  ...
  // Get available categories for Moncler products
  ...
  if (productsError) {
    console.error("Error fetching Moncler products:", productsError)
  }
