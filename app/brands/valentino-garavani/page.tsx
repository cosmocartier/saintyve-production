...
import { ValentinoGaravaniClient } from "@/components/brands/valentino-garavani-client"
...
export default async function ValentinoGaravaniPage({
  searchParams,
}: {
  ...
  // Get available categories for Valentino Garavani products
  ...
  if (productsError) {
    console.error("Error fetching Valentino Garavani products:", productsError)
  }
