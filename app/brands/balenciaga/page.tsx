...
import { BalenciagaClient } from "@/components/brands/balenciaga-client"
...
export default async function BalenciagaPage({
  searchParams,
}: {
  ...
  // Get available categories for Balenciaga products
  ...
  if (productsError) {
    console.error("Error fetching Balenciaga products:", productsError)
  }
