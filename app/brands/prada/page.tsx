...
import { PradaClient } from "@/components/brands/prada-client"
...
export default async function PradaPage({
  searchParams,
}: {
  ...
  // Get available categories for Prada products
  ...
  if (productsError) {
    console.error("Error fetching Prada products:", productsError)
  }
