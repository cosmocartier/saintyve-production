...
import { AirJordanClient } from "@/components/brands/air-jordan-client"
...
export default async function AirJordanPage({
  ...
  // Get available categories for Jordan products
  ...
  if (productsError) {
    console.error("Error fetching Jordan products:", productsError)
  }
