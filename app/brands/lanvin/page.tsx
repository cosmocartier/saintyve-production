...
import { LanvinClient } from "@/components/brands/lanvin-client"
...
export default async function LanvinPage({
  searchParams,
}: {
  ...
  // Get available categories for Lanvin products
  ...
  if (productsError) {
    console.error("Error fetching Lanvin products:", productsError)
  }
