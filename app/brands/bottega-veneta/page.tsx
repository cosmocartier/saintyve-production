...
import { BottegaVenetaClient } from "@/components/brands/bottega-veneta-client"
...
export default async function BottegaVenetaPage({
  searchParams,
}: {
  ...
  // Get available categories for Bottega Veneta products
  ...
  if (productsError) {
    console.error("Error fetching Bottega Veneta products:", productsError)
  }
