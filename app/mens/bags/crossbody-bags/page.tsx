...
import { MensBagsClient } from "@/components/mens/mens-bags-client"
import { CartSidebar } from "@/components/cart-sidebar"
import { Footer } from "@/components/footer"

const INITIAL_LOAD_LIMIT = 20
const CATEGORY_NAME = "Mens Crossbody Bags"

export default async function MensCrossbodyBagsPage() {
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <MensBagsClient
          ...
          pageTitle="MEN'S CROSSBODY BAGS"
        />
      </div>
