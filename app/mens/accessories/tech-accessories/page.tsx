...
import { MensAccessoriesClient } from "@/components/mens/mens-accessories-client"
import { CartSidebar } from "@/components/cart-sidebar"
import { Footer } from "@/components/footer"

const INITIAL_LOAD_LIMIT = 20
const CATEGORY_NAME = "Mens Tech Accessories"

export default async function MensTechAccessoriesPage() {
  ...
  // Fetch products for the Mens Tech Accessories category
  ...
  return (
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <MensAccessoriesClient
          initialProducts={optimizedProducts}
          totalCount={totalCount || 0}
          initialLimit={INITIAL_LOAD_LIMIT}
          categoryId={category.id}
          activeCategoryLabel="Tech Accessories"
          pageTitle="MEN'S TECH ACCESSORIES"
        />
      </div>
