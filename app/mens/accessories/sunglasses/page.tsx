...
const CATEGORY_NAME = "Mens Sunglasses"

export default async function MensSunglassesPage() {
  ...
  // Fetch products for the Mens Sunglasses category
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <MensAccessoriesClient
          ...
          activeCategoryLabel="Sunglasses"
          pageTitle="MEN'S SUNGLASSES"
        />
      </div>
