...
const CATEGORY_NAME = "Mens Belts"

export default async function MensBeltsPage() {
  ...
  // Fetch products for the Mens Belts category
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <MensAccessoriesClient
          ...
          activeCategoryLabel="Belts"
          pageTitle="MEN'S BELTS"
        />
      </div>
