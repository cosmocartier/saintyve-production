...
const CATEGORY_NAME = "Mens Scarves"

export default async function MensScarvesPage() {
  ...
  // Fetch products for the Mens Scarves category
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <MensAccessoriesClient
          ...
          activeCategoryLabel="Scarves"
          pageTitle="MEN'S SCARVES"
        />
      </div>
