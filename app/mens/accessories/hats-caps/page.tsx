...
const CATEGORY_NAME = "Mens Hats & Caps"

export default async function MensHatsCapsPage() {
  ...
  // Fetch products for the Mens Hats & Caps category
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <MensAccessoriesClient
          ...
          activeCategoryLabel="Hats & Caps"
          pageTitle="MEN'S HATS & CAPS"
        />
      </div>
