...
const CATEGORY_NAME = "Mens Cardholders"

export default async function MensCardholdersPage() {
  ...
  // Fetch products for the Mens Cardholders category
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <MensAccessoriesClient
          ...
          activeCategoryLabel="Cardholders"
          pageTitle="MEN'S CARDHOLDERS"
        />
      </div>
