...
const CATEGORY_NAME = "Mens Jewelry"

export default async function MensJewelryPage() {
  ...
  // Fetch products for the Mens Jewelry category
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <MensAccessoriesClient
          ...
          activeCategoryLabel="Jewelry"
          pageTitle="MEN'S JEWELRY"
        />
      </div>
