...
import { distributorLogin } from "@/app/actions/distributor-auth"
      ...
      <AnimatePresence>
        {error && (
          <motion.p
            ...
            className="font-sans text-[11px] text-red-400/80"
          >
            {error}
          </motion.p>
        )}
...
export default function DistributorLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const result = await distributorLogin(email, password, rememberDevice)
    ...
    setTimeout(() => {
      router.push(`/distributor/${result.distributorId}`)
      router.refresh()
    }, 1200)
  }
    ...
    >
      ...
      <main className="relative z-10 flex min-h-[calc(100vh-57px)] flex-col items-center justify-center px-4 pb-24 pt-20">
        ...
        >
          ...
          <StatusPill label="Distributor Portal" />
                ...
                >
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-between">
                        ...
                        >
                          Password
                          <span className="ml-0.5 text-[#D6C7A1]/60">*</span>
                        </Label>
                        <Link
                          href="/distributor/forgot-password"
                          className="font-sans text-[9px] font-medium uppercase tracking-[0.16em] text-white/25 transition-colors hover:text-white/50"
                          tabIndex={0}
                        >
                          Forgot password?
                        </Link>
                      ...
                      <input
                        ...
                        className={[
                          "mt-2 w-full rounded-lg border px-4 py-3.5 font-sans text-sm text-white/90 outline-none transition-all duration-200",
                          "bg-[#1C1C1C] placeholder:text-white/20",
                          "focus:border-[#D6C7A1]/60 focus:shadow-[0_0_0_2px_rgba(214,199,161,0.08)]",
                          passwordError
                            ? "border-red-800/60"
                            : "border-[#2A2A2A] hover:border-white/12",
                  ...
                  >
                    ...
                    <Label
                      ...
                      className="cursor-pointer font-sans text-[10px] font-medium uppercase tracking-[0.16em] text-white/30 transition-colors hover:text-white/50"
                    >
                  ...
                  <motion.div
                    ...
                    className="space-y-5"
                  >
                    <EnterPortalButton loading={formState === "loading"} />

                    {/* Secondary action */}
                    <p className="text-center font-sans text-[10px] font-light tracking-wide text-white/25">
                      Don&apos;t have access?{" "}
                      <Link
                        href="/apply"
                        className="text-white/35 underline-offset-2 transition-colors hover:text-white/55 hover:underline"
                      >
                        Request access
                      </Link>
                    </p>
  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{
          boxShadow: "inset 0 0 0 1px rgba(214,199,161,0.15)",
        }}
        aria-hidden
      />
    </motion.button>
