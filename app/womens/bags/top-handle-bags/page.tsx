...
const CATEGORY_NAME = "Womens Top Handle Bags"

export default async function WomensTopHandleBagsPage() {
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <WomensBagsClient
          ...
          activeCategoryLabel="Top Handle Bag"
          pageTitle="WOMEN'S TOP HANDLE BAGS"
        />
      </div>
