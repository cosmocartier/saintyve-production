...
const CATEGORY_NAME = "Womens Shoulder Bags"

export default async function WomensShoulderBagsPage() {
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <WomensBagsClient
          ...
          activeCategoryLabel="Shoulder Bag"
          pageTitle="WOMEN'S SHOULDER BAGS"
        />
      </div>
