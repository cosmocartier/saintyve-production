...
import { WomensBagsClient } from "@/components/womens/womens-bags-client"
import { CartSidebar } from "@/components/cart-sidebar"
import { Footer } from "@/components/footer"

const INITIAL_LOAD_LIMIT = 20
const CATEGORY_NAME = "Womens Wallets & Cardholders"

export default async function WomensWalletsPage() {
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <WomensBagsClient
          ...
          activeCategoryLabel="Wallets & Cardholders"
          pageTitle="WOMEN'S WALLETS & CARDHOLDERS"
        />
      </div>
