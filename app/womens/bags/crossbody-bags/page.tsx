...
const CATEGORY_NAME = "Womens Crossbody Bags"

export default async function WomensCrossbodyBagsPage() {
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <WomensBagsClient
          ...
          activeCategoryLabel="Crossbody Bag"
          pageTitle="WOMEN'S CROSSBODY BAGS"
        />
      </div>
