...
import { WomensAccessoriesClient } from "@/components/womens/womens-accessories-client"
...
const CATEGORY_NAME = "Womens Accessories"

export default async function WomensAccessoriesPage({
  searchParams,
}: {
