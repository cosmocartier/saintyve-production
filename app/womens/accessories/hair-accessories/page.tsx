...
const CATEGORY_NAME = "Womens Hair Accessories"

export default async function WomensHairAccessories() {
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <WomensAccessoriesClient
          ...
          activeCategoryLabel="Hair Accessories"
          pageTitle="WOMEN'S HAIR ACCESSORIES"
        />
      </div>
