...
const CATEGORY_NAME = "Womens Leather Jackets"

export default async function WomensLeatherJacketsPage() {
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <WomensOuterwearClient
          ...
          activeCategoryLabel="Leather Jacket"
          pageTitle="WOMEN'S LEATHER JACKETS"
        />
      </div>
