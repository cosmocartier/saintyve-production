...
const CATEGORY_NAME = "Womens Puffer Jackets"

export default async function WomensPufferJacketsPage() {
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <WomensOuterwearClient
          ...
          activeCategoryLabel="Puffer Jacket"
          pageTitle="WOMEN'S PUFFER JACKETS"
        />
      </div>
