...
const CATEGORY_NAME = "Womens Trench Coats"

export default async function WomensTrenchCoatsPage() {
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <WomensOuterwearClient
          ...
          activeCategoryLabel="Trench Coat"
          pageTitle="WOMEN'S TRENCH COATS"
        />
      </div>
