...
const CATEGORY_NAME = "Womens Bomber Jackets"

export default async function WomensBomberJacketsPage() {
    ...
    <div className="min-h-screen bg-white text-black font-mono">
      ...
      <div className="pt-20">
        <WomensOuterwearClient
          ...
          activeCategoryLabel="Bomber Jacket"
          pageTitle="WOMEN'S BOMBER JACKETS"
        />
      </div>
