...
import { ClothingClient } from "@/components/category-pages/clothing/clothing-client"
...
export async function generateMetadata({
  ...
  return {
    title: "Clothing | Designerdrip",
    description:
      "Discover premium clothing at Designerdrip — shirts, pants, tops, and more from top designer brands.",
    openGraph: {
      title: "Clothing | Designerdrip",
      description:
        "Discover premium clothing at Designerdrip — shirts, pants, tops, and more from top designer brands.",
      type: "website",
      url: "https://designerdrip.com/clothing",
    },
    twitter: {
    ...
    alternates: {
      canonical: "https://designerdrip.com/clothing",
    },
    robots: {
...
export default async function ClothingPage({
  ...
  // Build query with filters - fetch directly from products table where category = 'clothing'
  let query = supabase
    .from("products")
    .select(`
      *,
  ...
  if (pcError) {
    console.error("Error fetching clothing:", pcError)
  }
  ...
  // Fetch all filter options server-side for products with category = 'clothing'
  const filterOptions = await getFilterOptionsForCategory("Clothing")
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Clothing",
                item: "https://designerdrip.store/clothing",
              },
            ],
          }),
        }}
