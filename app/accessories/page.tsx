...
import { AccessoriesClient } from "@/components/category-pages/accessories/accessories-client"
...
export async function generateMetadata({
  ...
  return {
    title: "Designer Accessories (AA+ Quality) | Designerdrip",
    description:
      "Shop premium designer accessories with AA+ craftsmanship — belts, hats, sunglasses & essentials from top labels. Fast worldwide shipping. New drops weekly.",
    openGraph: {
      title: "Designer Accessories (AA+ Quality) | Designerdrip",
      description:
        "Shop premium designer accessories with AA+ craftsmanship — belts, hats, sunglasses & essentials from top labels. Fast worldwide shipping. New drops weekly.",
      type: "website",
      url: "https://designerdrip.com/accessories",
    },
    twitter: {
    ...
    alternates: {
      canonical: "https://designerdrip.com/accessories",
    },
    robots: {
...
export default async function AccessoriesPage({
  ...
  if (!accessoriesCategory) {
    ...
    return <div>Error: Accessories category not configured</div>
  }
  ...
  if (pcError) {
    console.error("Error fetching accessories:", pcError)
  }
  ...
  const filterOptions = await getFilterOptionsForCategory(accessoriesCategory.id)
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Accessories",
                item: "https://designerdrip.store/accessories",
              },
            ],
          }),
        }}
